...
<head>
	...
	<!-- Título de la web -->
	<title>User | <?= $this->page_title ?></title>
	<!-- Favicon web -->
...
<body>
							...
							<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
								...
								<li class="nav-item">
									<a class="nav-link<?php if ($this->active === 'perfil') {
															echo ' active';
														} ?>" href="index.php?controller=user&&action=perfil">Perfil</a>
								</li>
								<li class="nav-item">
									<a class="nav-link<?php if ($this->active === 'tarjetas') {
															echo ' active';
														} ?>" href="index.php?controller=user_view_card">Tarjetas</a>
								</li>
								<li class="nav-item">
									<a class="nav-link<?php if ($this->active === 'animales') {
															echo ' active';
														} ?>" href="index.php?controller=user_animales">Animales</a>
								</li>
								<li class="nav-item">
									<a class="nav-link<?php if ($this->active === 'zoo') {
															echo ' active';
														} ?>" href="index.php?controller=user_zoos">Zoo</a>
								</li>
								<li class="nav-item">
								...
								<a class="btn btn-success"><i class="fa-solid fa-shopping-cart"> </i> CARRITO <span class="badge bg-red">10</span></a>
							</ul>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="col-12 text-center text-bg-warning py-3 mb-3 rounded">
			...
			<p class="small"> USER DASHBOARD </p>
		</div>
		<?= $this->get_message(); ?>
	</div>